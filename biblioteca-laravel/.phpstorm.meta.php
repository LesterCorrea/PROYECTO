...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\lenovo\Downloads\PROYECTO\biblioteca-laravel\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\lenovo\\Downloads\\PROYECTO\\biblioteca-laravel\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'session.http_only','session.same_site','session.partitioned','activitylog.enabled','activitylog.delete_records_older_than_days',
...
'activitylog.database_connection','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'role_or_permission',);
        registerArgumentsSet('routes', 'home','books.index','books.show','books.search',
'magazines.index','magazines.show','magazines.search','collections.index','collections.show',
'authors.index','authors.show','pdf.serve','pdf.progress','comments.store',
'comments.destroy','student.dashboard','student.reservations.index','student.reservations.store','student.reservations.cancel',
'student.fines','student.history','librarian.dashboard','librarian.libros.index','librarian.libros.create',
'librarian.libros.store','librarian.libros.show','librarian.libros.edit','librarian.libros.update','librarian.libros.destroy',
'librarian.revistas.index','librarian.revistas.create','librarian.revistas.store','librarian.revistas.show','librarian.revistas.edit',
'librarian.revistas.update','librarian.revistas.destroy','librarian.autores.index','librarian.autores.create','librarian.autores.store',
'librarian.autores.show','librarian.autores.edit','librarian.autores.update','librarian.autores.destroy','librarian.categorias.index',
'librarian.categorias.create','librarian.categorias.store','librarian.categorias.show','librarian.categorias.edit','librarian.categorias.update',
'librarian.categorias.destroy','librarian.editoriales.index','librarian.editoriales.create','librarian.editoriales.store','librarian.editoriales.show',
'librarian.editoriales.edit','librarian.editoriales.update','librarian.editoriales.destroy','librarian.colecciones.index','librarian.colecciones.create',
'librarian.colecciones.store','librarian.colecciones.show','librarian.colecciones.edit','librarian.colecciones.update','librarian.colecciones.destroy',
'librarian.colecciones.addBook','librarian.colecciones.removeBook','librarian.reservations','librarian.reservations.confirm','librarian.reservations.reject',
'librarian.loans.index','librarian.loans.store','librarian.loans.return','librarian.fines.index','librarian.fines.pay',
'librarian.carruseles.index','librarian.carruseles.create','librarian.carruseles.store','librarian.carruseles.show','librarian.carruseles.edit',
'librarian.carruseles.update','librarian.carruseles.destroy','librarian.carruseles.addItem','librarian.carruseles.removeItem','librarian.carruseles.reorder',
'admin.dashboard','admin.usuarios.index','admin.usuarios.create','admin.usuarios.store','admin.usuarios.show',
'admin.usuarios.edit','admin.usuarios.update','admin.usuarios.destroy','admin.usuarios.toggle','admin.usuarios.role',
'admin.reports.index','admin.reports.loans','admin.reports.fines','admin.reports.users','admin.reports.export',
'admin.logs.index','register','login',
...
'layouts.app','layouts.guest','layouts.navigation','profile.edit','profile.partials.delete-user-form',
'profile.partials.update-password-form','profile.partials.update-profile-information-form','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
