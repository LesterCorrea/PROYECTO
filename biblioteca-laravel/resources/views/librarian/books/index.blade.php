...
<div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
        <p class="text-sm text-gray-500 dark:text-gray-400">
            {{ $books->total() }} libro(s) en total
        </p>
        <a href="{{ route('librarian.libros.create') }}"
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
                    ...
                    <th class="text-left px-6 py-3 font-semibold text-gray-600 dark:text-gray-400 hidden md:table-cell">Categoría</th>
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="min-w-0">
                                <p class="font-semibold text-gray-900 dark:text-gray-100 truncate">{{ $book->title }}</p>
                                <p class="text-xs text-gray-500 dark:text-gray-400">{{ $book->author->name ?? '—' }}</p>
                                <p class="text-xs text-gray-400 dark:text-gray-500">ISBN: {{ $book->isbn }}</p>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="px-6 py-4 text-center">
                        <span class="font-semibold {{ $book->available_copies > 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-500' }}">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center justify-end gap-2">
                            ...
                            <a href="{{ route('librarian.libros.edit', $book) }}"
                            ...
                            <form method="POST"
                                action="{{ route('librarian.libros.destroy', $book) }}"
                ...
                <tr>
                    <td colspan="4" class="px-6 py-16 text-center">
                        <p class="text-gray-400 dark:text-gray-500 mb-3">No hay libros registrados aún</p>
                        <a href="{{ route('librarian.libros.create') }}"
