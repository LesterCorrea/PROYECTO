...
@section('page-title', 'Editoriales')

@section('content')
<div class="space-y-4">

    <div class="flex items-center justify-between">
        <p class="text-sm text-gray-500 dark:text-gray-400">{{ $publishers->total() }} editorial(es)</p>
        <a href="{{ route('librarian.editoriales.create') }}"
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
                    <th class="text-left px-6 py-3 font-semibold text-gray-600 dark:text-gray-400">Editorial</th>
                    <th class="text-left px-6 py-3 font-semibold text-gray-600 dark:text-gray-400 hidden md:table-cell">País</th>
                    <th class="text-left px-6 py-3 font-semibold text-gray-600 dark:text-gray-400 hidden lg:table-cell">Web</th>
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                    <td class="px-6 py-4">
                        <p class="font-semibold text-gray-900 dark:text-gray-100">{{ $publisher->name }}</p>
                    </td>
                    ...
                    <td class="px-6 py-4 hidden lg:table-cell">
                        ...
                        <a href="{{ $publisher->website }}" target="_blank"
                            class="text-indigo-600 dark:text-indigo-400 hover:underline text-xs truncate block max-w-xs">
                            {{ $publisher->website }}
                        </a>
                        @else
                    ...
                    <td class="px-6 py-4 text-center font-semibold text-gray-600 dark:text-gray-400 hidden md:table-cell">
                        {{ $publisher->magazines_count }}
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex items-center justify-end gap-2">
                            <a href="{{ route('librarian.editoriales.edit', $publisher) }}"
                            ...
                            <form method="POST"
                                action="{{ route('librarian.editoriales.destroy', $publisher) }}"
