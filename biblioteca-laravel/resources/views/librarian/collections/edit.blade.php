...
@section('page-title', 'Editar colección')

@section('content')
<div class="max-w-2xl">
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
        <form method="POST"
            action="{{ route('librarian.colecciones.update', $coleccione) }}"
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name', $coleccione->name) }}" required
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                    class="w-full px-4 py-2.5 text-sm rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none">{{ old('description', $coleccione->description) }}</textarea>
            </div>
            ...
            <div class="flex items-center gap-4 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-700">
                <img src="{{ asset('storage/'.$coleccione->cover_image) }}"
                    alt="Portada actual"
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    Nueva portada <span class="text-gray-400 text-xs">(opcional)</span>
                </label>
